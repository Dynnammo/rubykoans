...
class AboutClassMethods < Neo::Koan
  ...
  # The one that used the self keyword when defining each class methods, as it also allows us
  # to create instances methods

  # Are there times you might prefer one over the other?
  # When defining uniquely class methods, the second one is more neat
