...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Take the beginning value of result as argument and iterate trhrough array while applying 
    # a function about the item and the result
  end
  ...
  #   # code to read 'file'
  # => Thus we assure that the file is closed after use
